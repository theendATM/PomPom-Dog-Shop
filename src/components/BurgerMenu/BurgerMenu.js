            ...
            <div id="shade">
                <div id="pane">
                    ...
                    <div id="buttons-container">
                        <button onClick={()=>{changeNavStyle("MAIN_PAGE"); navigate("/");close()}} isActive={btnStates.main}>Главная</button>
                        <button onClick={()=>{changeNavStyle("ALLPETS_PAGE"); navigate("/all");close()}} isActive={btnStates.allPets}>Все питомцы</button>
                        <button onClick={()=>{changeNavStyle("ABOUT_PAGE"); navigate("/about");close()}} isActive={btnStates.about}>О нас</button>
